...
*/
    ...
    var qc = function (a) {
            if (a instanceof pc && a.constructor === pc && a.Sj === oc)
                return a.Aj;
...
*/
    ...
    k.toString = function () {
        ...
        if (!this.R) return '';
        for (
            var a = [], b = Array.from(this.R.keys()), c = 0;
            c < b.length;
            c++
        ) {
            var d = b[c],
...
*/
    ...
    var of = function (a, b) {
        ...
        rf = function (a, b) {
            if (G['fireauth.oauthhelper.ui.soy.appVerificationScreen'])
                return G['fireauth.oauthhelper.ui.soy.appVerificationScreen'](
                    a,
                    b,
                );
            a =
    ...
    k.clear = function () {
        for (var a = tf(this).keys, b = a.length - 1; 0 <= b; b--)
            this.remove(a[b]);
    };
    k.jh = function (a) {
        this.xa.cookie = a;
    ...
    xf.prototype.isEnabled = function (a) {
        ...
        if ('undefined' !== typeof this.P[a]) {
            ...
            if (
                ...
                (this.P[a].expiration &&
                    this.P[a].expiration.getTime() <= Date.now())
            )
            ...
            null === c &&
                ...
                this.P[b.toString()].expiration &&
                    (d = parseInt(
                        (this.P[b.toString()].expiration.getTime() -
                            Date.now()) /
                            1e3,
                        10,
                    )),
    ...
    Qf.prototype.init = function (a, b) {
        ...
        d
            ...
            : ((this.offsetX =
                  Cb || void 0 !== a.offsetX ? a.offsetX : a.layerX),
              (this.offsetY =
                  Cb || void 0 !== a.offsetY ? a.offsetY : a.layerY),
    ...
    var Yf = function (a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.Yd && f.listener == b && f.capture == !!c && f.Ne == d)
                return e;
        }
        return -1;
    };
    ...
    k.handleEvent = function (a) {
        ...
        if (yb && 'keypress' == a.type) {
            ...
            (Cb || zb) && 'keypress' == a.type
                ? ((d = this.rb),
                  (e =
                      0 <= b.charCode && 63232 > b.charCode && og(d)
                          ? b.charCode
                          : 0))
                : ('keypress' == a.type
                      ? (uh && (c = this.Uf),
        ...
        d
            ? 63232 <= d && d in sh
                ...
                : 25 == d && a.shiftKey && (f = 9)
            : b.keyIdentifier &&
              b.keyIdentifier in th &&
              (f = th[b.keyIdentifier]);
        if (
            !Bb ||
            'keypress' != a.type ||
    ...
    var Ah = function (a, b) {
        ...
        Ch = function (a, b, c) {
            ...
            a.Ic().listen(b, 'key', function (d) {
                13 == d.keyCode &&
                    (d.stopPropagation(), d.preventDefault(), c(d));
            });
        },
        Dh = function (a, b, c) {
            b = new xg(b);
    ...
    var Oh = function (a, b) {
            ...
            if (G['firebaseui.auth.soy2.element.submitButton'])
                return G['firebaseui.auth.soy2.element.submitButton'](
                    { label: b },
                    a,
                );
            a = H(
        ...
        Qh = function (a, b) {
            ...
            G['firebaseui.auth.soy2.element.infoBar']
                ? (b = G['firebaseui.auth.soy2.element.infoBar'](
                      { message: a },
                      b,
                  ))
        ...
        Sh = function (a, b) {
            ...
            if (G['firebaseui.auth.soy2.element.busyIndicator'])
                return G['firebaseui.auth.soy2.element.busyIndicator'](
                    { Ij: b },
                    a,
                );
            a = H(
    ...
    var Xh = {},
        ...
        Zh = function (a, b) {
            ...
            a = a.Zh;
            if (Xh[a] && Xh[a].length)
                for (var c = 0; c < Xh[a].length; c++)
                    Xh[a][c].dispatchEvent(b);
        };
    var $h = {
            Om: {
                'google.com':
    ...
    var di = function (a, b) {
            if (G['firebaseui.auth.soy2.page.passwordRecoveryEmailSent'])
                return G['firebaseui.auth.soy2.page.passwordRecoveryEmailSent'](
                    a,
                    b,
                );
        ...
        ei = function (a, b) {
            ...
            if (G['firebaseui.auth.soy2.element.newPassword'])
                a = G['firebaseui.auth.soy2.element.newPassword'](
                    { label: a },
                    b,
                );
            else {
        ...
        gi = function (a, b) {
            ...
            G['firebaseui.auth.soy2.page.passwordResetSuccess']
                ? (b = G['firebaseui.auth.soy2.page.passwordResetSuccess'](
                      { B: a },
                      b,
                  ))
                : ((b =
        ...
        hi = function (a, b) {
            ...
            G['firebaseui.auth.soy2.page.passwordResetFailure']
                ? (b = G['firebaseui.auth.soy2.page.passwordResetFailure'](
                      { B: a },
                      b,
                  ))
                : ((b =
        ...
        oi = function (a, b) {
            ...
            pe();
            if (
                G['firebaseui.auth.soy2.page.revertSecondFactorAdditionSuccess']
            )
                b = G[
                    'firebaseui.auth.soy2.page.revertSecondFactorAdditionSuccess'
                ]({ factorId: c, phoneNumber: d, B: a }, b);
            else {
    ...
    var Hi = function () {
        ...
        Ii = function () {
            return G['firebaseui.auth.soy2.strings.errorLoginAgain_']
                ? G['firebaseui.auth.soy2.strings.errorLoginAgain_'](
                      null,
                      void 0,
                  )
                ...
                : (Ah(a, !1),
                  Gh(
                      ...
                      (G['firebaseui.auth.soy2.strings.errorMissingPassword']
                          ? G[
                                'firebaseui.auth.soy2.strings.errorMissingPassword'
                            ](void 0, void 0)
                          : 'Enter your password'
                      ).toString(),
                  ),
...
*/
            ...
            for (var d = (c = !1); a.Bf.length && !a.cg; ) {
                ...
                if ((f = a.Ed ? g : f))
                    try {
                        ...
                        h === yj && (h = void 0);
                        void 0 !== h &&
                            ((a.Ed = a.Ed && (h == b || h instanceof Error)),
                            (a.ua = b = h));
                        if (
                            Rg(b) ||
                            ('function' === typeof q.Promise &&
                                b instanceof q.Promise)
                        )
                            (d = !0), (a.cg = !0);
                    } catch (l) {
                        (b = l), (a.Ed = !0), zj(a) || (c = !0);
    ...
    Hj.prototype.send = function (a, b, c, d) {
        ...
        if ('setAttributionReporting' in this.l && this.Yf)
            try {
                ...
                Je(
                    this.U,
                    Kj(this, 'Error SetAttributionReporting: ' + g.message),
                );
            }
        try {
            Lj(this),
    ...
    Hj.prototype.aj = function () {
        this.isDisposed() ||
            (this.Dg || this.Ue || this.cc ? Pj(this) : this.ml());
    };
                ...
                try {
                    ...
                    if (d)
                        ...
                        try {
                            ...
                            Je(a.U, 'Can not get status: ' + h.message),
                                (g = '');
                        }
                        a.Jd = g + ' [' + Rj(a) + ']';
                        Nj(a);
    ...
    Hj.prototype.getAllResponseHeaders = function () {
        return this.l && 2 <= Qj(this)
            ? this.l.getAllResponseHeaders() || ''
            : '';
    };
    var Kj = function (a, b) {
    ...
    var il = function (a) {
            var b = a && a.code;
            return b
                ? new R(b.substring(5), a.message, a.serverResponse)
                : null;
        },
        hl = {
    ...
    var Bm = function (a, b, c, d) {
            ...
            c &&
                ((this.Yb['X-Client-Version'] = c),
                (this.yf['X-Client-Version'] = c));
    ...
    var Dm = function (a, b) {
            b
                ? (a.Yb['X-Firebase-Locale'] = b)
                : delete a.Yb['X-Firebase-Locale'];
        },
        Fm = function (a, b) {
            b &&
        ...
        Gm = function (a, b) {
            b
                ? ((a.Yb['X-Client-Version'] = b),
                  (a.yf['X-Client-Version'] = b))
                : (delete a.Yb['X-Client-Version'],
                  delete a.yf['X-Client-Version']);
        };
    ...
    var Km = function (a, b) {
        ...
        Mm = function (a) {
            a = a.email;
            if ('string' !== typeof a || !mk.test(a))
                throw new R('invalid-email');
        },
        Nm = function (a) {
            'email' in a && Mm(a);
        },
        ...
        return new K(function (r, u) {
            n
                ? ((e =
                  ...
                  d.tl.postMessage({ eventType: a, eventId: e, data: b }, [
                      n.port2,
                  ]))
    ...
    var Zo = function () {
            this.og = { Browser: Vo, Node: Wo, ReactNative: Xo, Worker: Yo }[
                uk()
            ];
        },
        $o,
        ...
        if (a && a.nk) {
            ...
            if (null == b)
                ...
                if (this.Hl)
                    ...
                    else if (this.sa[b] === d && 'undefined' === typeof a.Y.Vg)
                        return;
                var f = this;
                c = function () {
                    if (
    ...
    Jp.prototype.fc = function () {
        return this.Hd
            ...
            : (this.Hd = pk().then(
                  function () {
                      if (
                          'function' !== typeof P('universalLinks.subscribe', q)
                      )
                          throw Kp(
                      ...
                      if (
                          'function' !==
                          typeof P('cordova.plugins.browsertab.openUrl', q)
                      )
                          throw Kp(
                      ...
                      if (
                          'function' !==
                          typeof P('cordova.InAppBrowser.open', q)
                      )
                          throw Kp(
            ...
            q.handleOpenURL = function (g) {
                0 ==
                    g
                        .toLowerCase()
                        .indexOf(
                            P('BuildInfo.packageName', q).toLowerCase() + '://',
                        ) && e({ url: g });
                if ('function' === typeof f)
                    try {
                        f(g);
    ...
    var Cq = function (a, b) {
        ...
        this.Li = b || null;
        Yk(this, {
            lastSignInTime: Ok(b || null),
            creationTime: Ok(a || null),
        });
    };
    ...
    var Dq = function (a, b, c, d, e, f) {
        ...
        T = function (a, b, c) {
            ...
            var d = firebase.SDK_VERSION
                ? yk('JsCore', firebase.SDK_VERSION)
                : null;
        ...
        Iq = function (a, b) {
            ...
            Gm(
                ...
                firebase.SDK_VERSION
                    ? yk('JsCore', firebase.SDK_VERSION, a.Z)
                    : null,
            );
        },
        Lq = function (a, b) {
                ...
                .then(function (c) {
                    ...
                    A(b.providerData, function (d) {
                        'password' === d.providerId &&
                            (Q(d, 'displayName', b.displayName),
                            Q(d, 'photoURL', b.photoURL));
                    });
                    return Qq(b);
                })
                .then(Sq),
    ...
    k.sendEmailVerification = function (a) {
        ...
        return this.m(
            this.getIdToken()
                .then(function (d) {
                    c = d;
                    return 'undefined' === typeof a || hc(a)
                        ? {}
                        : cp(new bp(a));
                })
                .then(function (d) {
    ...
    k.verifyBeforeUpdateEmail = function (a, b) {
        ...
        return this.m(
            this.getIdToken()
                .then(function (e) {
                    d = e;
                    return 'undefined' === typeof b || hc(b)
                        ? {}
                        : cp(new bp(b));
                })
                .then(function (e) {
        ...
        return a.Xa && !c
            ...
            : b.h(function (d) {
                  !d ||
                      ...
                      (a.Xa || a.dispatchEvent(new tq('userInvalidated')),
                      (a.Xa = d));
                  throw d;
              });
    };
    ...
    U.prototype.gd = function (a) {
        this.Qa === a ||
            ...
            ((this.Qa = a),
            Dm(this.j, this.Qa),
            this.dispatchEvent(new Br(this.Qa)));
    };
    ...
    U.prototype.fl = function (a) {
        ...
        Gm(
            this.j,
            firebase.SDK_VERSION
                ? yk('JsCore', firebase.SDK_VERSION, this.Z)
                : null,
        );
            ...
            get: function () {
                if (this.u) {
                    ...
                    b = Zk({
                        ...
                        port: b.gb,
                        options: Zk({
                            disableWarnings: this.u.disableWarnings,
                        }),
                    });
                } else b = null;
                return b;
    ...
    k.delete = function () {
        this.Ka = !0;
        for (var a = 0; a < this.ia.length; a++)
            this.ia[a].cancel('app-deleted');
        this.ia = [];
        this.Ya &&
            ((a = this.Ya), a.s.removeListener(nr('local'), a.F, this.xg));
    ...
    Y(dp.prototype, {
        confirm: { name: 'confirm', g: [W('verificationCode')] },
    });
    Z(
        Fl,
        'fromJSON',
        ...
        ps = function (a, b) {
            ...
            if ('auth/weak-password' === c) {
                ...
                if (G['firebaseui.auth.soy2.strings.error'])
                    b = G['firebaseui.auth.soy2.strings.error'](
                        { code: d },
                        void 0,
                    );
                else
            ...
            return new K(function (c, d) {
                ...
                L(Gj(f))
                    .then(function () {
                        ...
                        P('firebaseui.auth.AuthUI')
                            ? c(P('firebaseui.auth.AuthUI'))
                            : d(b);
                    })
                    .h(function () {
                        clearTimeout(e);
...
*/
    ...
    Hs = (function () {
            ...
            if (!u.defaultPrevented) {
                ...
                for (var Kb = C.length, Da; r < Kb; r++) {
                    if ((Da = C[r])) {
                        ...
                        m.push(Ni);
                        for (var Oi = 0, ct = Da.fg.length; Oi < ct; Oi++)
                            Da.fg[Oi](n);
        ...
        function g(n) {
            Array.isArray(n) ||
                (n =
                    n instanceof Element ? [n] : Array.prototype.slice.call(n));
        ...
        return {
            ...
            register: function (n) {
                var r = !0;
                if (
                    'undefined' !== typeof n.Pf ||
                    'undefined' !== typeof n.widget
                )
                    r = n.Pf || n.widget;
                var u = {
                ...
                if (
                    n.constructor.prototype.hasOwnProperty(
    ...
    (function () {
        ...
        a.prototype.Ql = function (b) {
            this.i.classList.contains(this.Qj.Rj) ||
                (this.ij.style.width = b + '%');
        };
    ...
    Qs.prototype.pe = function () {
        ...
        if ((a = Pe('status-container-label')) && this.Nc) {
            ...
            df(a, c);
            rb(Ks, this.Nc.replace('-', '_').toLowerCase()) &&
                If(a, 'firebase-rtl');
        }
    };
    var Rs = function () {
    ...
    var Ss = function (a) {
        ...
        Ys = function (a) {
            if (a.Da)
                ...
                if (a.ab)
                    return (
                        'file://asset/www/index.html?apn=' +
                        encodeURIComponent(a.ab)
                    );
                if (a.Gb)
                    return (
                        'file://asset/www/index.html?ibi=' +
                        encodeURIComponent(a.Gb)
                    );
            }
            return null;
        },
        ...
        $s = function (a) {
            if (!a.apiKey)
                throw (Nk('No API key available'), new R('bad-request'));
            a.ib = new Bm(
                a.apiKey,
                Vj(a.De),
                yk('Handler', '2.20.3', a.xd),
                a.Ch,
            );
            a.ib.M = a.If;
        },
    ...
    Ss.prototype.handleError = function (a) {
        ...
        if (
            a instanceof R &&
            ('auth/unauthorized-domain' === a.code ||
                'auth/bad-request' === a.code)
        )
            ...
            var b =
                ...
                ('auth/dynamic-link-not-activated' != a.code &&
                    ...
                    ? (G['fireauth.oauthhelper.ui.soy.temporaryErrorMessage']
                          ? G[
                                'fireauth.oauthhelper.ui.soy.temporaryErrorMessage'
                            ](void 0, void 0)
    ...
    var nt = function (a) {
        ...
        if (!a.Da && b && /popup/i.test(a.authType || '')) {
            ...
            for (c = 0; c < a.ae.length; c++)
                b.push(
                    uo(a.ae[c], 'getParentOrigin', null, 2e4).then(
                        function (f) {
                            for (var g = 0; g < f.length; g++)
                                f[g].fulfilled &&
                                    f[g].value &&
                                                    ...
                                                    function (u) {
                                                        return u
                                                            ...
                                                            : Pm(
                                                                  ...
                                                                  d,
                                                                  l +
                                                                      '#webwidgetstarter_projectNumber',
                                                                  {},
                                                                  null,
                                                                  null,
                                                              ).then(
