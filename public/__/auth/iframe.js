    ...
    function Fa(a, b) {
        function c() {
            ...
            return k.run(function () {
                return a.call.apply(
                    a,
                    [h].concat(f instanceof Array ? f : fa(l(f))),
                );
            });
        }
...
(function () {
    ...
    ea('Promise', function (a) {
        ...
        e.prototype.Oe = function (g, h) {
            ...
            var m = this;
            null == this.wd ? f.Rh(l) : this.wd.push(l);
            this.Pi = !0;
        };
        e.resolve = c;
        e.reject = function (g) {
...
*/
    ...
    var ob = function (a) {
            if (a instanceof nb && a.constructor === nb) return a.uj;
            Ia(
    ...
    var sb = function (a) {
            if (a instanceof rb && a.constructor === rb) return a.tj;
            Ia(
    ...
    function Mb() {
        return bb ? !!Jb && 0 < Jb.brands.length : !1;
    }
    function Nb() {
        return Mb() ? !1 : A('Trident') || A('MSIE');
    }
    function Ob() {
        return Mb()
            ? Lb('Chromium')
            : ((A('Chrome') || A('CriOS')) && !(Mb() ? 0 : A('Edge'))) ||
                  A('Silk');
    }
    var Pb = {},
        Qb = function (a, b) {
    ...
    var Rb = function (a) {
            if (a instanceof Qb && a.constructor === Qb) return a.sj;
            Ia(
...
*/
    ...
    function hc(a) {
        ...
        void 0 === b && ic(a.toString());
        return b || wb;
    }
    var jc = /^\s*(?!javascript:)(?:[a-z0-9+.-]+:|[^:\/?#]*(?:[\/?#]|$))/i;
    function kc(a) {
        a instanceof rb ? (a = sb(a)) : jc.test(a) || (ic(a), (a = void 0));
        return a;
    }
    var lc = [],
        ic = function () {};
            ...
            c instanceof lb
                ? c instanceof lb && c.constructor === lb && c.fk === kb
                    ...
                    : (Ia("expected object of type Const, got '" + c + "'"),
                      (c = 'type_error:Const'))
                : (c = c || '');
            return void 0 !== d ? b.open(sb(a), c, d) : b.open(sb(a), c);
        },
        Lc = /^[\w+/_-]+[=]{0,2}$/;
    var Oc = function (a, b) {
        for (
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
            ...
            if (a)
                if (cd(a)) {
                    if (a) {
                        D(
                            cd(a),
                            'arrayForEach was called with a non array value',
                        );
    ...
    var zd = function (a) {
        ...
        Ad = function (a) {
            ...
            if (a.parent) return Ad(a.parent);
    ...
    var $d =
        ...
        be = function () {
            ...
            null == a &&
                ...
                (a = Kd(b, 'authuser') || null),
                null == a && (a = (a = b.match($d)) ? a[1] : null));
        ...
        ce = function () {
            ...
            null == a &&
                (a = (a = window.location.href.match(ae)) ? a[1] : null);
            if (null == a) return null;
            a = String(a);
            21 < a.length && (a = null);
            return a;
    ...
    var ee,
        ...
        Ie = function (a) {
            a = String(a);
            if (qe.test(a) || se.test(a) || te.test(a) || ue.test(a)) return !1;
            var b = a.replace(ve, '""');
            b = b.replace(we, '0');
            b = b.replace(xe, '');
            if (ye.test(b)) return !1;
            b = b.replace(ze, '0');
            b = b.replace(Ae, '0');
            if (
                Be.test(b) ||
    ...
    Pe.prototype.update = function (a, b) {
        if (null != a) {
            ...
            for (
                ...
                if (0 == f)
                    for (; d <= c; ) Qe(this, a, d), (d += this.blockSize);
                if ('string' === typeof a)
                    for (; d < b; ) {
                        if (
                            ((e[f] = a.charCodeAt(d)),
    ...
    var af = function () {
        ...
        bf = function (a, b) {
            b = b.onload;
            return 'function' === typeof b ? (af().a(a, b), b) : null;
        },
        cf = function (a) {
    ...
    var ef = {
        ...
        hf = function (a, b) {
            var c = 0;
            do var d = b.id || ['I', gf++, '_', new Date().getTime()].join('');
        ...
        kf = function (a, b, c, d) {
            ...
            g ||
                ((c = Ke(Kd(a.location.href, 'jcp', ''))) &&
                    ...
                    (g = jf(c.id, c.pfname)));
            h.pfname = g;
            d.connectWithJsonParam && ((g = {}), (g.jcp = Le(h)), (h = g));
            ...
            b = Qd(b);
            b.query.push.apply(b.query, Sd(e, d));
        ...
        mf = function (a, b, c, d, e) {
            ...
            try {
                ...
                f ||
                    ((f = (a ? new Zc(Yc(a)) : Ea || (Ea = new Zc())).wk(
                        'IFRAME',
                    )),
                    g &&
                        ((f.onload = function () {
    ...
    function Jf(a, b, c) {
        ...
        d ||
            Lf(c, function () {
                var e = '';
                0 < e.length && (e += ': ');
                return e + 'Expected ' + a.Bi().trim() + ', got ' + Ef(b);
            });
        return d;
    }
    function Lf(a, b) {
    ...
    var Mf = function () {
        this.Bb = [];
        this.ki = this.qk = this.kk = !1;
    };
    Mf.prototype.lb = function (a) {
        this.ki = !0;
        return this.Bb.length ? Nf(this, this.Bb[0], a) : void 0;
    };
    var Nf = function (a, b, c) {
            c =
                void 0 === c
                    ...
                    : c;
            if (!b.Te) return b.instance;
            c = c(b.Te);
            a.qk && (delete b.Te, (b.instance = c));
            return c;
        },
        Of = function () {
    ...
    ng.prototype.reset = function () {
        this.context = this.vd = this.Qc = this.child = null;
        this.Pd = !1;
    };
    var og = new Uf(
            function () {
    ...
    var Jh = 0,
        ...
        Yh = function (a, b, c) {
            a = Wh(a);
            Mh[a.name] = { Xd: b, je: a.je, Ca: c || Uh };
            Xh();
        },
        Zh = {},
        $h = function (a, b) {
        ...
        ai = function (a, b, c, d) {
            ...
            if (q && '..' !== f) {
                if (B.Qg) {
                    if (!(m = Lh[f].dm)) {
                        m = Qh ? Qh.substring(1).split('/') : [Ch];
                        y = m.length - 1;
                        for (f = C.parent; f !== C.top; ) {
                            var S = f.parent;
                            if (!y--) {
                                for (
    ...
    if (
        'function' === typeof C.postMessage ||
        'object' === typeof C.postMessage
    )
        (Th = new Gh()),
            Yh('__cb', $h, function () {
                return !0;
        ...
        ji = function (a) {
            if (!a.closed && a.document && a.document.body)
                if (
                    ...
                    var b = Yc(a);
                    a.appendChild(
                        b.createTextNode('Please close this window.'),
                    );
                }
        };
    ...
    k.Gc = function () {
        if (!this.isDisposed()) {
            ...
            delete Gg.kb[this.getFrameName()];
            this.Cb = !0;
        }
    };
    k.getContext = function () {
    ...
    k.unregister = function (a, b) {
        ...
        d &&
            (b
                ? ((b = dd.call(d, b)), 0 <= b && d.splice(b, 1))
                : d.splice(0, d.length),
            0 == d.length &&
                ((b = dd.call(this.Bb, a)),
    ...
    k.Hj = function (a, b) {
        new H(b).i._relayedDepth ||
            ((b = {}), Yg(Ug(new mh(b), '_opener')), ni(a, '_g_connect', b));
    };
    k.mj = function (a) {
        var b = this,
        ...
        return ni(this, '_g_open', a.value()).then(function (f) {
            var g = new H(f[0]),
                h = g.getFrameName();
            f = new H();
            var l = b.Fb(),
    ...
    k.wh = function (a) {
        ...
        var c = jh(a).value();
        b = {};
        for (var d in c) ed(c, d) && ed(Sg, d) && (b[d] = c[d]);
        ed(c, 'style') &&
            ((d = c.style), 'object' === typeof d && (b.style = mi(d)));
    ...
    var yi = function () {
            ...
            for (var b = 0, c = [document.body]; 0 < c.length; ) {
                ...
                if ('undefined' !== typeof d.style) {
                    ...
                    f ||
                        (f = (f = document.defaultView.getComputedStyle(
                            d,
                            null,
                        ))
                            ? f.overflowY
        ...
        Di = function (a, b, c) {
            ...
            if (d) {
                ...
                if (e) {
                    ...
                    if ((d = b.getStyle()))
                        if ((d = si[d])) sh(b, a), d(b.value()), sh(b, null);
        ...
        Ei = function (a, b, c) {
            ...
            if (d)
                if (
                    (D(
                        !!ui,
                        'Defer style is disabled, when requesting style ' + d,
                    ),
                    ri[d])
                )
                    Bi(a, b);
    ...
    J.prototype.open = function (a, b) {
        ...
        if (Di(this, c, d) || Ei(this, c, d) || Di(this, c, d))
            return d.promise;
        if (null != lh(c)) {
            var e = setTimeout(function () {
                    ...
                    d.reject({
                        timeout:
                            'Exceeded time limit of :' + lh(c) + 'milliseconds',
                    });
                }, lh(c)),
                f = d.resolve;
    ...
    J.prototype.addOnConnectHandler = function (a, b, c, d) {
        pi(this);
        'object' === typeof a
            ? ((b = new bh(a)), (c = b.i.role || ''))
            : ((b = eh(dh(ch(a), b).ze(c), d)), (c = a));
        d = this.rg[c] || [];
        a = !1;
        for (var e = 0; e < d.length && !a; e++)
            qi(this.kb[d[e].hf.getFrameName()], d[e].data, [b]),
                (a = b.i.runOnce);
        c = bd(this.Xg, c, []);
    ...
    J.prototype.Di = function (a, b) {
        if (b.i.openAsWindow) {
            a = Gi(this, a, b);
            var c = a.id;
            D(!!a.ak, 'Open popup window failed');
            b.i._popupWindow = a.ak;
        }
        return c;
    };
    Eg = md();
    ...
    r('gapi.iframes.Context.prototype.getFrameName', J.prototype.getFrameName);
    r(
    ...
    Ri.prototype.digest = function () {
        ...
        for (var c = 63; 56 <= c; c--) (this.Re[c] = b & 255), (b /= 256);
        Vi(this);
    ...
    aj.prototype.init = function (a, b) {
        ...
        d
            ...
            : ((this.offsetX =
                  wc || void 0 !== a.offsetX ? a.offsetX : a.layerX),
              (this.offsetY =
                  wc || void 0 !== a.offsetY ? a.offsetY : a.layerY),
    ...
    gj.prototype.add = function (a, b, c, d, e) {
        var f = a.toString();
        a = this.Qa[f];
        a || ((a = this.Qa[f] = []), this.Ge++);
        var g = hj(a, b, d, e);
        -1 < g
            ? ((b = a[g]), c || (b.Ne = !1))
            : ((b = new ej(b, this.src, f, !!d, e)), (b.Ne = c), a.push(b));
        return b;
    };
    ...
    var jj = 'closure_lm_' + ((1e6 * Math.random()) | 0),
        kj = {},
        lj = 0,
    ...
    k.dispatchEvent = function (a) {
        ...
        b = this.ik;
        d = a.type || a;
        if ('string' === typeof a) a = new Zi(a, b);
    ...
    k.send = function (a) {
        if (a)
            if ('string' == typeof a) this.Qb.send(a);
    ...
    Ij.prototype.Sd = function () {
        ...
        this.Fc && a.zh(this.Fc);
        this.Yc && a.Gj(this.Yc);
        return a;
    };
    ...
    Jj.prototype.Rk = function (a) {
        if (this.Sb) {
            if (this.Be && a.value) this.response.push(a.value);
                ...
                if ((b = this.Kh.decode(b, { stream: !a.done })))
    ...
    Jj.prototype.Ze = function () {
        var a = this.Da;
        a && Gd(a, td, 'Failed to fetch url ' + this.hb);
        this.Sb && Lj(this);
    };
    var Lj = function (a) {
        a.readyState = 4;
...
*/
    ...
    Oj.prototype.cancel = function (a) {
        if (this.md) this.Ua instanceof Oj && this.Ua.cancel();
            ...
            if (this.Ha) {
                var b = this.Ha;
                delete this.Ha;
                a ? b.cancel(a) : (b.lg--, 0 >= b.lg && b.cancel());
            }
    ...
    var Zj = function (a) {
        ...
        Sj = function (a) {
            if (a.Uf && a.md && Zj(a)) {
                var b = a.Uf,
                    c = ak[b];
                c && (p.clearTimeout(c.Pa), delete ak[b]);
                a.Uf = 0;
            }
            a.Ha && (a.Ha.lg--, delete a.Ha);
            b = a.Ua;
    ...
    var bk = function (a) {
        this.Pa = p.setTimeout(u(this.tm, this), 0);
        this.yb = a;
    };
    ...
    var gk = function (a) {
            ...
            e.onerror = function () {
                dk(e, !0, h);
                Pj(g, new ek(0, 'Error while loading script ' + d));
            };
            f = b.attributes || {};
    ...
    K.prototype.send = function (a, b, c, d) {
        ...
        'withCredentials' in this.u &&
            ...
            (this.u.withCredentials = this.dk);
        if ('setTrustToken' in this.u && this.Lh)
            try {
                ...
                try {
                    ...
                    if (d)
                        ...
                        try {
                            ...
                            Id(a.Da, 'Can not get status: ' + h.message),
                                (g = '');
                        }
                        a.ie = g + ' [' + a.getStatus() + ']';
                        qk(a);
    ...
    var angular,
        ...
        dl = function (a, b, c) {
            ...
            d =
                e instanceof rb
                    ? e
                    : hc('undefined' != typeof e.href ? e.href : String(e));
        ...
        sl = function (a, b, c) {
            ...
            for (f = 0; f < c.length; f++)
                'undefined' !== typeof e[c[f]] &&
                    (delete e[c[f]], d.push(c[f]));
            d.sort();
            c = d;
        ...
        Bl = function (a) {
            a = a || Vk();
            return 'Safari' == $k(a) ||
                a.toLowerCase().match(/iphone|ipad|ipod/)
                ? !1
                : !0;
        },
        Cl = function () {
    ...
    P.prototype.T = function () {
        ...
        this.Dj && (a.serverResponse = this.Dj);
        return a;
    };
    ...
    var Yl = function (a) {
            var b = a && a.code;
            return b
                ? new P(b.substring(5), a.message, a.serverResponse)
                : null;
        },
        Xl = {
    ...
    var Cm = function (a) {
            ...
            var b = a;
            t(a) && (b = a.accessToken);
            return new Bm().credential({ accessToken: b });
        },
        Dm = function () {
    ...
    var Em = function (a) {
            ...
            var b = a;
            t(a) && (b = a.accessToken);
            return new Dm().credential({ accessToken: b });
        },
        Fm = function () {
            Am.call(this, 'google.com');
    ...
    var Gm = function (a, b) {
            ...
            return new Fm().credential({ idToken: c, accessToken: b });
        },
        Hm = function () {
    ...
    var Pm = function (a) {
        ...
        Qm = function (a) {
            a = im(a);
            return (a = hm(a)) && 'EMAIL_SIGNIN' === a.operation ? a : null;
        };
    ...
    Pl(Xm, { PROVIDER_ID: 'phone' });
    Pl(Xm, { PHONE_SIGN_IN_METHOD: 'phone' });
    var bn = function (a) {
    ...
    var fn = ha(['https://apis.google.com/js/client.js?onload=', '']),
        gn = function (a) {
            this.Dm = a;
        };
    n(gn, Bj);
    ...
    var mn = function (a, b, c) {
        ...
        on = function (a, b) {
            b
                ? (a.ld['X-Firebase-Locale'] = b)
                : delete a.ld['X-Firebase-Locale'];
        },
        qn = function (a, b) {
            b &&
        ...
        rn = function (a, b) {
            b
                ? ((a.ld['X-Client-Version'] = b),
                  (a.Mf['X-Client-Version'] = b))
                : (delete a.ld['X-Client-Version'],
                  delete a.Mf['X-Client-Version']);
        },
        ...
        g.listen('complete', function () {
            ...
            try {
                ...
                try {
                    ...
                    Id(this.Da, 'Can not get responseText: ' + B.message),
                        (y = '');
                }
                l = q.call(m, y) || null;
            } catch (B) {
    ...
    mn.prototype.lm = function (a, b, c, d, e) {
        ...
        nn.then(function () {
            ...
            b &&
                b({
                    error: { message: (g && g.message) || 'CORS_UNSUPPORTED' },
                });
        });
    };
    var wn = function (a, b) {
    ...
    var Ym = function (a, b) {
        ...
        Un = function (a) {
            if (
                !a.requestUri ||
                (!a.sessionId && !a.postBody && !a.pendingToken)
            )
                throw new P('internal-error');
        },
        Vn = function (a, b) {
    ...
    var Q = function (a, b, c) {
            ...
            return F(c)
                ...
                .then(function () {
                    ...
                    b.ta &&
                        ...
                        (c.tenantId = a.ma);
                    return d
                        ? xn(a, a.Ii, b.endpoint, e, c, b.ei, b.ng || !1)
                        : xn(a, a.ri, b.endpoint, e, c, b.ei, b.ng || !1);
                })
                .then(function (g) {
                    f = g;
                    return b.Hf ? b.Hf(c, f) : f;
                })
                .then(b.Aa)
                .then(function () {
                    if (!b.Zb) return f;
        ...
        vn = function (a, b) {
            var c =
                ((a.error && a.error.errors && a.error.errors[0]) || {})
                    .reason || '';
            var d = {
    ...
    var no = ha(['https://apis.google.com/js/api.js?onload=', '']),
        po = function (a) {
            this.hb = a;
            this.kf = null;
            this.Yg = oo(this);
    ...
    vo.prototype.toString = function () {
        ...
        'function' === typeof this.Bd.zi &&
            ((c = this.Bd.zi()), c.length && L(a, 'scopes', c.join(',')));
        this.oh
    ...
    var Bo = function (a, b, c, d, e, f, g, h, l, m, q, y) {
        a = new vo(a, b, c, d, e, y);
        a.oh = f;
        a.Ja = g;
        f = a.Dh(h);
        f.Ke = Za(l || null);
        return f.Ah(m).Ch(q).toString();
    };
    xo.prototype.rh = function () {
        ...
        this.jf.qh('authEvent', function (b) {
            ...
            if (b && b.authEvent) {
                var d = !1;
                b = $l(b.authEvent);
                for (c = 0; c < a.Vb.length; c++) d = a.Vb[c](b) || d;
                c = {};
        ...
        return a
            ...
            .then(function (c) {
                if (
                    c &&
                    c.length &&
                    'undefined' !== typeof c[0].webStorageSupport
                )
    ...
    var Do = ha([
        ...
        Eo = function () {
            this.hd = p.grecaptcha ? Infinity : 0;
            this.Gi = null;
    ...
    Ho.prototype.render = function (a, b) {
        this.ab[this.hd.toString()] = new Io(a, b);
        return this.hd++;
    };
    Ho.prototype.reset = function (a) {
        var b = Jo(this, a);
        a = Ko(a);
        b && a && (b.delete(), delete this.ab[a]);
    };
    ...
    var Jo = function (a, b) {
            return (b = Ko(b)) ? a.ab[b] || null : null;
        },
        Ko = function (a) {
            return (a = 'undefined' === typeof a ? 1e12 : a)
                ? a.toString()
                : null;
        },
        Lo = null,
    ...
    var Po = function (a, b, c, d, e, f, g) {
        ...
        this.qf = 'invisible' === this.tc.size;
        if (!p.document)
            throw new P(
                'operation-not-supported-in-this-environment',
    ...
    k.reset = function () {
        Ro(this);
        null !== this.Od && this.be.reset(this.Od);
    };
    var Ro = function (a) {
        if (a.jd)
            throw new P(
        ...
        return new E(function (y, B) {
            q
                ? ((e =
                  ...
                  (f = function (S) {
                      S.data.eventId === e &&
                          ('ack' === S.data.status
                              ...
                              : 'done' === S.data.status
                                ? (clearTimeout(h),
                                  'undefined' !== typeof S.data.response
                                      ? y(S.data.response)
                  ...
                  d.Nl.postMessage({ eventType: a, eventId: e, data: b }, [
                      q.port2,
                  ]))
                ...
                ? ((this.uc = Yo(nl() ? self : null)),
                  this.uc.subscribe('keyChanged', function (b, c) {
                      return ip(a).then(function (d) {
                          ...
                          return { keyProcessed: Qa(d, c.key) };
                      });
                  }),
        ...
        mp = function (a) {
            return new E(function (b, c) {
                ...
                d.onsuccess = function (e) {
                    e = e.target.result;
                    e.objectStoreNames.contains(a.xf)
                        ? b(e)
                        : lp(a)
                              .then(function () {
                                  return mp(a);
        ...
        return op(this, function (e) {
            ...
            .then(function (e) {
                return op(c, function (f) {
                    f = pp(c, qp(c, f, !0));
                    if (e) return (e.value = b), rp(f.put(e));
                    c.me++;
                    d = !0;
                    var g = {};
                    g[c.wg] = a;
    ...
    jp.prototype.remove = function (a) {
        ...
        return op(this, function (d) {
            b = !0;
            c.me++;
            return rp(pp(c, qp(c, d, !0))['delete'](a));
        })
            .then(function () {
                delete c.Ra[a];
                return sp(c, a);
    ...
    var yp = function () {
            this.zg = { Browser: up, Node: vp, ReactNative: wp, Worker: xp }[
                ol()
            ];
        },
        zp,
    ...
    Bp.prototype.Pg = function (a) {
        ...
        if ((b = a.iOS) && 'object' === typeof b)
            if (((b = b.bundleId), 'string' === typeof b && b.length))
                this.Hi = b;
            else {
                if ('undefined' !== typeof b)
                    throw new P(
    ...
    var Op = function (a) {
        ...
        Np = function (a) {
            ...
            'undefined' !== typeof a.isNewUser
                ? (c = !!a.isNewUser)
                : 'identitytoolkit#SignupNewUserResponse' === a.kind &&
                  (c = !0);
            O(this, 'providerId', b);
            O(this, 'isNewUser', c);
        },
    ...
    Rp.prototype.Oj = function (a) {
        if (a && a.Mk) {
            ...
            if (null == b)
                ...
                'undefined' !== typeof a.Ya.fh
                    ? Up(this, 'local').zc(this.Jh)
                    : Xp(this);
                if (this.hm)
                    if (
                        ((c = p.localStorage.getItem(b)),
                        (d = a.Ya.newValue),
                        d !== c)
                    )
                        null !== d
    ...
    hq.prototype.Nc = function () {
        return this.fe
            ...
            : (this.fe = kl().then(
                  function () {
                      if (
                          'function' !== typeof N('universalLinks.subscribe', p)
                      )
                          throw iq(
                      ...
                      if (
                          'function' !==
                          typeof N('cordova.plugins.browsertab.openUrl', p)
                      )
                          throw iq(
                      ...
                      if (
                          'function' !==
                          typeof N('cordova.InAppBrowser.open', p)
                      )
                          throw iq(
                    ...
                    nq(a).then(function (h) {
                        ...
                        if (h && g && g.url) {
                            ...
                            -1 != l.indexOf('/__/auth/callback') &&
                                ((m = M(l)),
                                (m = Al(Mk(m, 'firebaseError') || null)),
                                (m = (m = 'object' === typeof m ? Yl(m) : null)
                                    ? new Zl(
                                          h.getType(),
                                          h.Ja,
                                          null,
            ...
            p.handleOpenURL = function (g) {
                0 ==
                    g
                        .toLowerCase()
                        .indexOf(
                            N('BuildInfo.packageName', p).toLowerCase() + '://',
                        ) && e({ url: g });
                if ('function' === typeof f)
                    try {
                        f(g);
    ...
    k.Ig = function (a) {
        ...
        if (a && a.getUid() && this.Ff.hasOwnProperty(a.getUid())) return !1;
        for (var b = !1, c = 0; c < this.Ce.length; c++) {
            var d = this.Ce[c];
            if (d.Wh(a.getType(), a.Ja)) {
                if ((b = this.Bc[a.getType()]))
                    b.vj(a, d),
                        a &&
                            (a.ae() || a.Ja) &&
                            ((this.Ff[a.getUid()] = !0),
    ...
    var Hq = function (a, b) {
            ...
            if (a.ue.length) for (var c = 0; c < a.ue.length; c++) a.ue[c](b);
        },
        Iq = function (a, b) {
            a.Dd = function () {
                return F(b);
            };
            if (a.ve.length) for (var c = 0; c < a.ve.length; c++) a.ve[c](b);
        },
        Gq = function (a, b, c, d) {
    ...
    var Oq = function (a, b, c, d) {
        ...
        Pq = function (a, b, c) {
            return c.Zd().then(function (d) {
                ...
                ab(d, { phoneVerificationInfo: Tm(a.Wg) });
                return Q(b, io, d);
            });
        },
        Qq = function (a) {
    ...
    var Rq = function (a) {
        Qq.call(this, a);
        if (this.Wg.providerId != Xm.PROVIDER_ID)
            throw new P(
                'argument-error',
    ...
    var Yq = function (a, b) {
        ...
        Zq = function (a, b) {
            ...
            a.Ta = b.refreshToken;
            b = b.expiresIn;
            Yq(a, 'undefined' !== typeof b ? Number(b) : void 0);
        };
    ...
    k.Wh = function (a, b) {
        return ('linkViaPopup' == a && (this.Kb || null) == b && this.Jb) ||
    ...
    var Dr = function (a, b, c, d, e) {
            ...
            d = d()
                ...
                .then(function (h) {
                    a.xc && ((h = a.xc), (h = h.O.set(Er, a.T(), h.V)));
                    return h;
                })
                .then(function () {
    ...
    k.sendEmailVerification = function (a) {
        ...
        return this.v(
            this.getIdToken()
                .then(function (d) {
                    c = d;
                    return 'undefined' === typeof a || Ya(a)
                        ? {}
                        : Cp(new Bp(a));
                })
                .then(function (d) {
    ...
    k.verifyBeforeUpdateEmail = function (a, b) {
        ...
        return this.v(
            this.getIdToken()
                .then(function (e) {
                    d = e;
                    return 'undefined' === typeof b || Ya(b)
                        ? {}
                        : Cp(new Bp(b));
                })
                .then(function (e) {
    ...
    T.prototype.updateCurrentUser = function (a) {
        ...
        return this.v(
            this.Lb.then(function () {
                ...
                .then(function () {
                    if (U(b) && a.uid == U(b).uid) return U(b).copy(a), b.oc(a);
                    Vr(b, d);
                    pr(d);
                    return b.oc(d);
                })
    ...
    var gs = function (a, b) {
            ...
            return a.Le.then(function () {
                ...
                .then(function (d) {
                    if (U(a) && d.uid == U(a).uid) return U(a).copy(d), a.oc(d);
                    Vr(a, d);
                    pr(d);
                    return a.oc(d);
                })
    ...
    k.delete = function () {
        ...
        this.Ka = [];
        this.Pb &&
            ((a = this.Pb), a.O.removeListener(Mr('local'), a.V, this.Hg));
    ...
    var $r = function (a) {
        Zi.call(this, 'languageCodeChanged');
        this.languageCode = a;
    };
    n($r, Zi);
    var bs = function (a) {
        Zi.call(this, 'emulatorConfigChanged');
        this.emulatorConfig = a;
    };
    n(bs, Zi);
    var cs = function (a) {
        Zi.call(this, 'frameworkChanged');
        this.Lk = a;
    };
    n(cs, Zi);
                                ...
                                return c
                                    ? c.session && c.phoneNumber
                                        ...
                                        : c.session && c.multiFactorHint
                                          ? vs(c.session, 'signin') &&
                                            ws(c.multiFactorHint)
                                          : c.session && c.multiFactorUid
                                            ? vs(c.session, 'signin') &&
                                              'string' ===
                                                  typeof c.multiFactorUid
                                            : c.phoneNumber
                                              ? 'string' ===
                                                typeof c.phoneNumber
                                              : !1
                                    : !1;
                            },
                        };
    ...
    Cs.prototype.qh = function (a, b) {
        if (this.Ih) this.ah.register(a, b, Jg);
    ...
    var Gs = function (a) {
        ...
        return cq(a.Hd)
            .then(function (c) {
                if ((b = c)) return Es(a.qc, c);
                c = ul() ? 'no-auth-event' : 'web-storage-unsupported';
                return Es(a.qc, new Zl('unknown', null, null, null, new P(c)));
            })
            .then(function () {
                if (b) {
                    var c = a.Hd;
            ...
            Hs.start().l(function (d) {
                if (d && 'auth/unauthorized-domain' == d.code)
                    (d = M(Hs.od())),
                        ...
                        Gl(d);
                else if (d && d.message) Gl(d.message);
                else throw d;
            });
        };
