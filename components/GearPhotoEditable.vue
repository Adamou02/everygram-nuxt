<template>
    <div
        :class="[
            'gear-photo flex align-items-center justify-content-center border-round-md overflow-hidden relative cursor-pointer',
            {
                'gear-photo--empty surface-100 text-color-lightest border-2 border-100 hover:border-dashed hover:border-400':
                    !displayImageUrl,
